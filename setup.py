...
setup(name="riscof",
      ...
      package_data={
          'riscof': [
              ...
              'suite/rv32i_m/M/*.S',
              'suite/rv32i_m/C/*.S', 
              'suite/rv32i_m/privilege/*.S',
              'suite/rv32i_m/Zicsr/*.S', 
              'suite/rv32i_m/Zifencei/*.S',
              'suite/rv32i_m/K_unratified/*.S',
              'suite/rv64i_m/I/*.S', 
              'suite/rv64i_m/M/*.S',
              'suite/rv64i_m/C/*.S', 
              'suite/rv64i_m/privilege/*.S',
              'suite/rv64i_m/Zicsr/*.S', 
              'suite/rv64i_m/Zifencei/*.S',
              'suite/rv64i_m/K_unratified/*.S',
