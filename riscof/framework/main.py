...
def run(dut_model,dut_env_file,base_model,base_env_file,dut_isa_spec,dut_platform_spec):
    ...
    if dut_env_file is not None:
      ...
      dut.initialise(file=dut_env_file,work_dir=work_dir,suite=constants.suite)
    else:
    ...
    if base_env_file is not None:
      ...
      base.initialise(file=base_env_file,work_dir=work_dir,suite=constants.suite)
    else:
